...
namespace DLL_Core
{
    public static class HttpUtils
    {
        ...
        public static int JHttpPost(Socket socket, string path, string payload, HttpStatusCode success = HttpStatusCode.OK)
        {
            string response = JHttpRequest(socket, "POST", path, payload);
        ...
        private static string JHttpRequest(Socket socket, string method, string path, string payload)
        {
            ...
            do
            {
                bytesReceived = socket.Receive(dataReceived, SocketFlags.None);
